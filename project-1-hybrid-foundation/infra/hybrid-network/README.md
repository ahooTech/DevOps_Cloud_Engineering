...
# created s3 for remote backend 

aws s3api create-bucket --bucket project1-terraform-state-ahootech --region us-east-1
aws s3api put-bucket-versioning --bucket project1-terraform-state-ahootech --versioning-configuration Status=Enabled